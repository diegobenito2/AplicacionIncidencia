...
////////////////////////////////////////////////////////Fin Spinner Elementos//////////////////////////////////////////////////////////////////////////////////
        ...
        tvFechaCreacion.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        btnGuardar.setOnClickListener(v -> {
            if (incidencia != null) {
                ...
                EntUsuario usuarioCreacion = uh.obtenerNombreUsuario(UsuarioSelected);
                incidencia.setIdUsuarioCreacion(usuarioCreacion.getCodigoUsuario());
                incidencia.setUsuarioCreacion(usuarioCreacion);
                ////////////////////////////////////////////////////////Spinner Elementos//////////////////////////////////////////////////////////////////////////////////
                Spinner spinnerElementos = findViewById(R.id.spinnerElemento);
                String ElementoSelected = spinnerElementos.getSelectedItem().toString();//Guardas el nombre del elemento seleccionado
                EntElemento elemento = eh.buscarNombreElemento(ElementoSelected);
                incidencia.setIdElemento(elemento.getCodigoElemento());
                incidencia.setElemento(elemento);
