...
////////////////////////////////////////////////////////Spinner Salas//////////////////////////////////////////////////////////////////////////////////
            ...
            ArrayList<EntSala> arSalas = sh.obtenerSalas();
...
////////////////////////////////////////////////////////DatePicker Fecha Inicio//////////////////////////////////////////////////////////////////////////////////
            ...
            if (fechaInicio != null) {
                ...
                fechaInicio = new Date("0000-00-00 00:00:00");
                tvFechaInicio.setText(format.format(fechaInicio));
            }
...
////////////////////////////////////////////////////////DatePicker Fecha Fin//////////////////////////////////////////////////////////////////////////////////
            ...
            if (fechaFin != null) {
                ...
                fechaFin = new Date("0000-00-00 00:00:00");
                tvFechaFin.setText(format.format(fechaFin));
            }
...
////////////////////////////////////////////////////////Spinner Salas//////////////////////////////////////////////////////////////////////////////////
                ...
                EntSala salaSeleccionada = sh.buscarNombreSala(SalaSelected);
                ubicacion.setSala(salaSeleccionada);
                ubicacion.setIdSala(salaSeleccionada.getCodigoSala());
////////////////////////////////////////////////////////Spinner Elementos//////////////////////////////////////////////////////////////////////////////////
                Spinner spinnerElementos = findViewById(R.id.spinnerElemento);
                ...
                ubicacion.setElemento(elementoSeleccionado);
                ubicacion.setIdElemento(elementoSeleccionado.getCodigoElemento());
////////////////////////////////////////////////////////DatePicker Fecha Inicio//////////////////////////////////////////////////////////////////////////////////
